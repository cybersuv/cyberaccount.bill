...
<title>${appName} :: Global Bill</title>
</head>
<body>
<center>
<form:form id="globalBillForm" action="#" method="POST">
<table class="formtable" cellspacing="0" >
<tr>
<td colspan="2" bgcolor="#848484" align="center"><font color="white">Global Bill Entry</font></td>
</tr>
<%-- <tr>
<td>Account</td>
...
<script>
  ...
  $( "#globalBillForm" ).submit(function( event ) {
	// Stop form from submitting normally
	event.preventDefault();
	// Get some values from elements on the page:
	var $form = $( this ),
	term = $form.find( "input[name='s']" ).val(),
	url = '${pageContext.request.contextPath}/globalentry';
