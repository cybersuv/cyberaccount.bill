...
<input name="reportType" id="reportType" type="hidden" value="${report_type}"/>
<table class="formtable" cellspacing="0">
<tr>
<td colspan="2" bgcolor="#848484" align="center"><font color="white">Bill Parameters</font></td>
</tr>
<tr>
<td>Month Stamp</td>
...
$(document).ready(function() {
  ...
  $( "#txForm" ).submit(function( event ) {
	...
	url = '${pageContext.request.contextPath}/getBillReport';
